...
export const CAMERA_PRESETS: CameraPreset[] = [
  { id: 'deck', label: 'Deck', pose: { position: [0, 3.2, 0], yawDeg: 20, pitchDeg: -6, fovDeg: 58 } },
  { id: 'wide', label: 'Wide ocean', pose: { position: [0, 16, 0], yawDeg: 30, pitchDeg: -4.5, fovDeg: 60 } },
  { id: 'glitter', label: 'Sun glitter', pose: { position: [0, 9, 0], yawDeg: 62, pitchDeg: -5, fovDeg: 55 } },
